...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    if (!formData.name.trim() || !formData.email.trim()) {
      toast.error("Please fill the required blank", {
    ...
    // 🔥 API call (no await → no delay)
    fetch("https://feedbackbackend-q0y7.onrender.com/api/v1/createFeedBack", {
      method: "POST",
      headers: {
  ...
  return (
    ...
    >
      ...
      <p className="text-lg text-gray-700 mb-8">
        Email:{" "}
        <a
          href="mailto:Nirpeshdhungel7@gmail.com"
          className="text-purple-600 hover:underline"
        >
          Nirpeshdhungel7@gmail.com
        </a>
        <br />
        Phone: <span className="text-purple-600">+977-9816988657</span>
        <br />
        Location:{" "}
        <span className="text-purple-600">Jhapa Gauradaha, Nepal</span>
      </p>
